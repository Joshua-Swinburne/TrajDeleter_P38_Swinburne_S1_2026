...
apptainer exec --nv --writable-tmpfs --fakeroot \
  ...
  bash -lc '
    cd unlearning
    python mujoco_trajdeleter_shortened.py --dataset hopper-medium-expert-v0 --seed 42 --gpu 0 --unlearning_rate 0.11 --model ./Fully_trained_agents/hopper-medium-expert-v0/CQL/params.json
    --model_params ./Fully_trained_agents/hopper-medium-expert-v0/CQL/model.pt --number_of_unlearning 0.11
  '
